...
const topics = ['GameBasedAptitude', 'DataInterpretation', 'VisualReasoning', 'Psychometric', 'Cryptarithmetic', 'EssayWriting'];
const displayNames = ['Game Based Aptitude', 'Data Interpretation', 'Visual Reasoning', 'Psychometric', 'Cryptarithmetic', 'Essay Writing'];
...
const ${topic} = () => {
      ...
      <div className="pyq-grid">
        <a href="/pyq/pyq1.pdf" target="_blank" rel="noopener noreferrer" className="pyq-card">
          ...
          <div className="pyq-info">
            <h4 className="pyq-name">${displayNames[i]} PYQ 1</h4>
          </div>
        </a>
        <a href="/pyq/pyq2.pdf" target="_blank" rel="noopener noreferrer" className="pyq-card">
          ...
          <div className="pyq-info">
            <h4 className="pyq-name">${displayNames[i]} PYQ 2</h4>
          </div>
        </a>
        <a href="/pyq/pyq3.pdf" target="_blank" rel="noopener noreferrer" className="pyq-card">
          ...
          <div className="pyq-info">
            <h4 className="pyq-name">${displayNames[i]} PYQ 3</h4>
          </div>
        </a>
      </div>
    </div>
  ...
  return (
    <TopicsGrid 
      topics={topics}
      bannerTitle="Ready to Test Your ${displayNames[i]}?"
      bannerSubtitle="Take a full length test and analyze your performance."
      bannerButtonText="Take an Online ${displayNames[i]} Test Now!"
...
`;
  ...
  fs.writeFileSync(topic + '.jsx', code);
});
