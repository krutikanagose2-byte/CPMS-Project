export const boschData = {
  pattern: {
    paragraphs: [
      "Bosch hires primarily for core engineering roles, focusing on domain knowledge (Mechanical, Electrical, Civil) along with basic aptitude."
    ],
    summary: [
