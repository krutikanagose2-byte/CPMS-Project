export const morgan_stanleyData = {
  pattern: {
    paragraphs: [
      "Morgan Stanley evaluates candidates heavily on quantitative aptitude, logical reasoning, and software engineering basics (for tech roles).",
