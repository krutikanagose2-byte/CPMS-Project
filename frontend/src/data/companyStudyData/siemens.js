export const siemensData = {
  pattern: {
    paragraphs: [
      "Siemens hires primarily for core engineering roles, focusing on domain knowledge (Mechanical, Electrical, Civil) along with basic aptitude."
    ],
    summary: [
