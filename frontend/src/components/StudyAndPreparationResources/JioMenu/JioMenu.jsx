...
const JioMenu = ({ company, onBack, onOpenAIInterview }) => {
        ...
        <nav className="csr-menu">
          ...
          {isSyllabusExpanded && (
            <div className="csr-submenu">
              ...
              <div className={`csr-menu-item ${activeMenu === 'Technical/Functional Test' ? 'active' : ''}`} onClick={() => setActiveMenu('Technical/Functional Test')} style={{ paddingLeft: '40px', fontSize: '0.95em' }}>
