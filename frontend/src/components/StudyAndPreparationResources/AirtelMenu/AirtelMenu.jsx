...
import HRManagerial from './HRManagerial';

const AirtelMenu = ({ company, onBack, onOpenAIInterview }) => {
        ...
        <nav className="csr-menu">
          ...
          {isSyllabusExpanded && (
            <div className="csr-submenu">
              ...
              <div className={`csr-menu-item ${activeMenu === 'HR/Managerial' ? 'active' : ''}`} onClick={() => setActiveMenu('HR/Managerial')} style={{ paddingLeft: '40px', fontSize: '0.95em' }}>
                HR/Managerial
              </div>
            </div>
          )}
