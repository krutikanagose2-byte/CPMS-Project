...
import GDCaseStudy from './GDCaseStudy';
import TechnicalInterview from './TechnicalInterview';
import HRInterview from './HRInterview';

const KPMGMenu = ({ company, onBack, onOpenAIInterview }) => {
        ...
        <nav className="csr-menu">
          ...
          {isSyllabusExpanded && (
            <div className="csr-submenu">
              ...
              <div className={`csr-menu-item ${activeMenu === 'GD / Case Study' ? 'active' : ''}`} onClick={() => setActiveMenu('GD / Case Study')} style={{ paddingLeft: '40px', fontSize: '0.95em' }}>
                GD / Case Study
              </div>
              ...
              <div className={`csr-menu-item ${activeMenu === 'HR/Recruiter Interview' ? 'active' : ''}`} onClick={() => setActiveMenu('HR/Recruiter Interview')} style={{ paddingLeft: '40px', fontSize: '0.95em' }}>
