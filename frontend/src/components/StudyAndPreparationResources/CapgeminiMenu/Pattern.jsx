        ...
        <div className="csr-summary-grid">
          <div className="csr-summary-card">
            <div className="csr-summary-content">
              ...
              <span className="csr-summary-value">1 OA + GD + 2 Interviews</span>
            </div>
          ...
          <table className="csr-table">
            ...
            <tbody>
              <tr>
                ...
                <td>Aptitude, Technical, Coding/Problem Solving</td>
                <td>90 - 120 mins</td>
              </tr>
              <tr>
                <td>Group Discussion (GD)</td>
                <td>Only for selected roles/drives</td>
                <td>15 - 20 mins</td>
              </tr>
              <tr>
                <td>Technical Interview</td>
                <td>Technical concepts, Projects</td>
                <td>45 - 60 mins</td>
              </tr>
              <tr>
                <td>HR/Behavioral Interview</td>
                <td>Communication, HR questions</td>
                <td>20 - 30 mins</td>
              </tr>
            </tbody>
          </table>
          ...
          {curriculumTab === 'Overview' && (
            <div className="csr-curr-content">
              ...
              <ol className="csr-curr-list num-list">
                ...
                <li>Group Discussion (Role Specific)</li>
                <li>Technical Interview</li>
                <li>HR/Behavioral Interview</li>
              </ol>

              <h3 className="csr-curr-subheading"><u>Online Assessment:</u></h3>
              <p className="csr-curr-text">Includes sections on Aptitude, Technical MCQ, and Coding/Problem Solving.</p>
              
              <h3 className="csr-curr-subheading"><u>Group Discussion (GD):</u></h3>
              <p className="csr-curr-text">Only for selected roles/drives to test communication and team skills.</p>
              
              <h3 className="csr-curr-subheading"><u>{company.name} Interviews:</u></h3>
              <p className="csr-curr-text">Technical Interview focuses on technical concepts and projects. The HR/Behavioral Interview tests communication and standard HR questions.</p>
            </div>
          )}
        </div>
      </div>
