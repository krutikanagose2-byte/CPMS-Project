...
const DeloitteMenu = ({ company, onBack, onOpenAIInterview }) => {
  ...
  const renderContent = () => {
    switch (activeMenu) {
      ...
      case 'Technical Assessment':
        return <TechnicalAssessment company={company} currentYear={currentYear} />;
      case 'Interview':
        ...
        <nav className="csr-menu">
          ...
          {isSyllabusExpanded && (
            <div className="csr-submenu">
              ...
              <div className={`csr-menu-item ${activeMenu === 'Technical Assessment' ? 'active' : ''}`} onClick={() => setActiveMenu('Technical Assessment')} style={{ paddingLeft: '40px', fontSize: '0.95em' }}>
                <span className="csr-menu-icon">💻</span> Technical Assessment
              </div>
