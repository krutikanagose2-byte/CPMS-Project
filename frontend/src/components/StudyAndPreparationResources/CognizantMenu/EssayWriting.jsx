        ...
        <div className="pyq-grid">
          <div className="pyq-card">
            <div className="pyq-image-container">
              <iframe
                src="https://www.youtube-nocookie.com/embed/videoseries?list=PLMufDeLh5x2DPgIWzaFQGkV7NOoCSqghI"
                title="Essay Writing Video Playlist"
            ...
            <div className="pyq-info">
              <a 
                href="https://youtube.com/playlist?list=PLMufDeLh5x2DPgIWzaFQGkV7NOoCSqghI" 
                target="_blank" 
