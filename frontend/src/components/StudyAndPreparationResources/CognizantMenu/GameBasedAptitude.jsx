        ...
        <div className="pyq-grid">
          <div className="pyq-card">
            <div className="pyq-image-container">
              <iframe
                src="https://www.youtube-nocookie.com/embed/videoseries?list=PLQit65uXNfmuZN18GULRSSp0Go2ofPsQC"
                title="Game Based Aptitude Video Playlist"
            ...
            <div className="pyq-info">
              <a 
                href="https://youtube.com/playlist?list=PLQit65uXNfmuZN18GULRSSp0Go2ofPsQC" 
                target="_blank" 
