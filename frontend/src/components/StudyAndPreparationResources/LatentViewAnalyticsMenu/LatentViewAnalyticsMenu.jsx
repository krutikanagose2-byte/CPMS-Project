...
import TechnicalInterview2 from './TechnicalInterview2';
import HRBehavioral from './HRBehavioral';

const LatentViewAnalyticsMenu = ({ company, onBack, onOpenAIInterview }) => {
        ...
        <nav className="csr-menu">
          ...
          {isSyllabusExpanded && (
            <div className="csr-submenu">
              ...
              <div className={`csr-menu-item ${activeMenu === 'Technical Interview 2' ? 'active' : ''}`} onClick={() => setActiveMenu('Technical Interview 2')} style={{ paddingLeft: '40px', fontSize: '0.95em' }}>
                Technical Interview 2
              </div>
              <div className={`csr-menu-item ${activeMenu === 'HR/Behavioral' ? 'active' : ''}`} onClick={() => setActiveMenu('HR/Behavioral')} style={{ paddingLeft: '40px', fontSize: '0.95em' }}>
                HR/Behavioral
              </div>
            </div>
          )}
...
export default LatentViewAnalyticsMenu;
